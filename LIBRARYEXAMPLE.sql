...
INSERT INTO Book_Details VALUE(1,'CLOUD COMPUTING','Thomos erl',500.00,'2001','V1');
...
INSERT INTO Book_Details VALUE
	(7, 'harry porter', 'J J Rollings', 495.00,'2010', 'v9'),
...
DELETE FROM Book_Details WHERE Book_id = 1;UPDATE Book_Details SET Volume = 'v1' WHERE Book_Id = 4;
